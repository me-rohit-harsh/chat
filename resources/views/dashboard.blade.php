                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <section class="jumbotron text-center d-flex align-items-center">
                        <div class="container">
                            ...
                            <p class="lead text-muted">Connect with your audience in real-time with our live chat web
                                application.
                                Engage, support, and communicate with ease.</p>
                            <p class="text-center">
                                <strong>Chat Section: </strong>
                                @if( Auth::user()->role =='admin')
                                <a href="{{route('admin.chat')}}" class="btn btn-primary my-2">All Live Chats</a>
                                @else
                                <a href="{{route('user.chat')}}" class="btn btn-secondary my-2">Chat Dashboard</a>
                                @endif
                            </p>
                            <p class="text-center">
